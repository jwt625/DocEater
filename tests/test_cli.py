...
class TestInitCommand:
    ...
    def test_init_command_failure(
        self, mock_get_settings, mock_get_db_manager, cli_runner, mock_settings
    ):
...
class TestWatchCommand:
    ...
    @patch("doceater.cli.get_db_manager")
    @patch("doceater.cli.get_settings")
    def test_watch_command_with_folder(
        self,
        mock_get_settings,
        mock_get_db_manager,
        mock_watcher_class,
    ...
    @patch("doceater.cli.get_db_manager")
    @patch("doceater.cli.get_settings")
    def test_watch_command_process_existing(
        self,
        mock_get_settings,
        mock_get_db_manager,
        mock_watcher_class,
...
class TestListCommand:
    ...
    @patch("doceater.cli.get_db_manager")
    def test_list_command_with_status_filter(
        self, mock_get_db_manager, cli_runner, mock_db_manager
    ):
    ...
    @patch("doceater.cli.get_db_manager")
    def test_list_command_invalid_status(
        self, mock_get_db_manager, cli_runner, mock_db_manager
    ):
...
class TestShowCommand:
    ...
    def test_show_command_success(
        ...
        result = cli_runner.invoke(
            app, ["show", "12345678-1234-5678-9012-123456789012"]
        )
    ...
    @patch("doceater.cli.get_db_manager")
    def test_show_command_invalid_uuid(
        self, mock_get_db_manager, cli_runner, mock_db_manager
    ):
...
class TestImagesCommand:
    ...
    @patch("doceater.cli.get_db_manager")
    @patch("doceater.cli.get_settings")
    def test_images_list_by_document(
        self,
        mock_get_settings,
        mock_get_db_manager,
        mock_storage_class,
        ...
        result = cli_runner.invoke(
            app,
            ["images", "list", "--document-id", "12345678-1234-5678-9012-123456789012"],
        )
    ...
    @patch("doceater.cli.get_db_manager")
    @patch("doceater.cli.get_settings")
    def test_images_invalid_action(
        self,
        mock_get_settings,
        mock_get_db_manager,
        cli_runner,
