...
class Settings(BaseSettings):
    ...
    allow_anonymous_health: bool = Field(
        default=True, description="Allow anonymous health checks"
    )
    jwt_secret_key: str = Field(
        default="", description="JWT secret key (auto-generated if empty)"
    )
    ...
    api_keys: str = Field(
        default="", description="API keys in format 'key1:user1,key2:user2'"
    )
