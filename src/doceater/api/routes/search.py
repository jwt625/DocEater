...
async def search_documents(
    ...
    logger.info(
        f"Search request received for query: '{request.query}' (feature not yet implemented)"
    )
...
async def find_similar_documents(
    ...
    logger.info(
        f"Similar search request received for document: {request.document_id} (feature not yet implemented)"
    )
